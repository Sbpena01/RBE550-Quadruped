...
class FrontRightLeg(Node):
    def __init__(self):
        super().__init__('front_right_leg')
        self.shoulder_publisher_ = self.create_publisher(Float64, 'front_right_shoulder_position', 10)
        self.leg_publisher_ = self.create_publisher(Float64, 'front_right_leg_position', 10)
        self.foot_publisher_ = self.create_publisher(Float64, 'front_right_foot_position', 10)
...
def main(args=None):
    ...
    while True:
        ...
        print('Publishing: ', front_right_leg.shoulder_angle, front_right_leg.leg_angle, front_right_leg.foot_angle)
