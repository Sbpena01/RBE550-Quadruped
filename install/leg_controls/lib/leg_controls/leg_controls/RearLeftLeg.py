...
class RearLeftLeg(Node):
    def __init__(self):
        super().__init__('rear_left_leg')
        self.shoulder_publisher_ = self.create_publisher(Float64, 'rear_left_shoulder_position', 10)
        self.leg_publisher_ = self.create_publisher(Float64, 'rear_left_leg_position', 10)
        self.foot_publisher_ = self.create_publisher(Float64, 'rear_left_foot_position', 10)
...
def main(args=None):
    ...
    while True:
        ...
        print('Publishing: ', rear_left_leg.shoulder_angle, rear_left_leg.leg_angle, rear_left_leg.foot_angle)
