...
#ifndef CUSTOM_INTERFACE__MSG__DETAIL__IMU_DATA__FUNCTIONS_H_
#define CUSTOM_INTERFACE__MSG__DETAIL__IMU_DATA__FUNCTIONS_H_
 ...
 * )) before or use
 * custom_interface__msg__ImuData__create()
 ...
 * calls
 * custom_interface__msg__ImuData__init().
...
/**
 * It calls
 * custom_interface__msg__ImuData__fini()
 ...
 * custom_interface__msg__ImuData__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * custom_interface__msg__ImuData__Sequence__fini()
 * on the array,
...
#endif  // CUSTOM_INTERFACE__MSG__DETAIL__IMU_DATA__FUNCTIONS_H_
