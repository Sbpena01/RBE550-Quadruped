...
static char custom_interface__msg__LegState__TYPE_NAME[] = "custom_interface/msg/LegState";
...
static rosidl_runtime_c__type_description__Field custom_interface__msg__LegState__FIELDS[] = {
  ...
  {
    {custom_interface__msg__LegState__FIELD_NAME__pose, 4, 4},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription custom_interface__msg__LegState__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *custom_interface__msg__LegState__get_individual_type_description_source(NULL),
