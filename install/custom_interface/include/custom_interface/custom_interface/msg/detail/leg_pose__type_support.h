...
#ifndef CUSTOM_INTERFACE__MSG__DETAIL__LEG_POSE__TYPE_SUPPORT_H_
#define CUSTOM_INTERFACE__MSG__DETAIL__LEG_POSE__TYPE_SUPPORT_H_
...
#endif  // CUSTOM_INTERFACE__MSG__DETAIL__LEG_POSE__TYPE_SUPPORT_H_
